...
export default () => {
  const leftNews = [
    {
      img: "/img/israel-palestinians-hostages-protest.avif",
    ...
    {
      img: "/img/israel-palestinians-usa-rubio.avif",
  ...
  const mainNews = [
    ...
    {
      img: "/img/gettyimages-2237635076.webp",
    ...
    {
      img: "/img/gettyimages-2227954844.avif",
    ...
    {
      img: "/img/gettyimages-2237925094.avif",
  ...
  const rightNews = [
    {
      img: "/img/cnn-opener-final-new.avif",
